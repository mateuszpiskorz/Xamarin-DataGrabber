...
### Attention!
**The following project is not yet completed with its main features to come. This project is another approach to the same idea used in another project (https://github.com/mateuszpiskorz/WPF-RPiSenseHat-Datagrabber-App).**
